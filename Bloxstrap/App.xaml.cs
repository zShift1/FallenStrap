...
namespace Bloxstrap
{
    ...
    public partial class App : Application
    {
...
#endif
        public const string ProjectOwner = "FallenStrap";
        public const string ProjectRepository = "FallenStrap/FallenStrap";
        public const string ProjectDownloadLink = "https://github.com/FallenStrap/FallenStrap/releases/latest";
        public const string ProjectHelpLink = "https://github.com/FallenStrap/FallenStrap";
        public const string ProjectSupportLink = "https://github.com/FallenStrap/FallenStrap/issues/new";
        ...
        public static readonly JsonManager<Settings> Settings = new ProfileSettingsManager();

        public static readonly ProfileManager Profiles = new();
        ...
        // set to true to relaunch straight into the settings menu after exit (used by profile switching)
        public static bool RelaunchToMenuAfterExit = false;
        ...
        {
            if (RelaunchToMenuAfterExit && Paths.Initialized && File.Exists(Paths.Application))
                Process.Start(new ProcessStartInfo(Paths.Application, "-menu") { UseShellExecute = false });
