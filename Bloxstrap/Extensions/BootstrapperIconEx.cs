...
namespace Bloxstrap.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            return icon switch
            {
                BootstrapperIcon.IconBloxstrap => IconEx.GetFallenStrapIcon(),
                ...
                // IconBloxstrapClassic was removed from the Selections list, but it's
                // kept here for backwards compatibility with existing saved settings
                BootstrapperIcon.IconBloxstrapClassic => IconEx.GetFallenStrapIcon(),
