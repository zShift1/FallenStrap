...
namespace Bloxstrap
{
    public class FastFlagManager : JsonManager<Dictionary<string, object>>
    {
        ...
        public override string FileLocation => App.Profiles.Resolve(Path.Combine(Paths.Modifications, "ClientSettings", FileName), FileName);
        ...
        public static IReadOnlyDictionary<string, string> PresetFlags = new Dictionary<string, string>
        {
            ...
            { "Rendering.GrassDistance", "FIntFRMMaxGrassDistance" },
            { "Rendering.DisableVoxelizer", "DFFlagDebugPauseVoxelizer" },
        };
        ...
        {
            [EnumName(StaticName = "Baja")] Low,
            [EnumName(StaticName = "Media")] Medium,
            [EnumName(StaticName = "Alta")] High,
            [EnumName(StaticName = "Máxima")] Ultra
        }

        public enum GrassDistance
        {
            [EnumName(StaticName = "Desactivada")] Off,
            [EnumName(StaticName = "Corta")] Short,
            [EnumName(StaticName = "Media")] Medium,
            [EnumName(StaticName = "Larga")] Long
        }

        public static IReadOnlyDictionary<GraphicsQuality, string?> GraphicsQualityLevels => new Dictionary<GraphicsQuality, string?>
        {
            { GraphicsQuality.Low, "3" },
            { GraphicsQuality.Medium, "8" },
            { GraphicsQuality.High, "14" },
            { GraphicsQuality.Ultra, "21" },
        };

        public static IReadOnlyDictionary<GrassDistance, string?> GrassDistances => new Dictionary<GrassDistance, string?>
        {
            { GrassDistance.Off, "0" },
            { GrassDistance.Short, "100" },
            { GrassDistance.Medium, "200" },
            { GrassDistance.Long, "300" },
        };
