    ...
    public static class LaunchHandler
    {
        public static void ProcessNextAction(NextAction action, bool isUnfinishedInstall = false)
        {
            ...
            switch (action)
            {
                ...
                case NextAction.LaunchFastFlags:
                    App.Logger.WriteLine(LOG_IDENT, "Opening settings on Fast Flags");
                    LaunchSettings(typeof(UI.Elements.Settings.Pages.FastFlagsPage));
                    break;
        ...
        public static void LaunchSettings(Type? pageType = null)
        {
