...
namespace Bloxstrap.UI.ViewModels.Installer
{
    public class LaunchMenuViewModel
    {
        ...
        public ICommand LaunchFastFlagsCommand => new RelayCommand(LaunchFastFlags);
        ...
        private void LaunchFastFlags() => CloseWindowRequest?.Invoke(this, NextAction.LaunchFastFlags);
