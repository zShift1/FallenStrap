    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? IconEx.GetFallenStrapIcon();
            }

            return icon switch
            {
                BootstrapperIcon.IconFallenStrap => IconEx.GetFallenStrapIcon(),
                ...
                // IconFallenStrapClassic was removed from the Selections list, but it's
                // kept here for backwards compatibility with existing saved settings
                BootstrapperIcon.IconFallenStrapClassic => IconEx.GetFallenStrapIcon(),
                _ => IconEx.GetFallenStrapIcon()
            };
        }
    }
}
