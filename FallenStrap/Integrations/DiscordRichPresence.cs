...
namespace FallenStrap.Integrations
{
    ...
    {
        private readonly DiscordRpcClient _rpcClient = new("1543151617782714399");
        ...
        public DiscordRichPresence(ActivityWatcher activityWatcher)
        {
            ...
            // the client library reconnects on its own every ~15s when Discord is closed, so a missing
            // Discord desktop does not affect anything here. still, never let an environment quirk take
            // the watcher down - rich presence is optional, the game is not.
            try
            {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, "Failed to initialize Discord RPC (is Discord Desktop running?)");
        ...
        private void ProcessSetRichPresence(Message message, bool implicitUpdate)
        {
            ...
            Models.FallenStrapRPC.RichPresence? presenceData;
            ...
            try
            {
                presenceData = message.Data.Deserialize<Models.FallenStrapRPC.RichPresence>();
            }
            catch (Exception)
            {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            string icon = "roblox";
            string smallImageText = "FallenStrap";
            string smallImage = "fallenstrap";
            ...
            // this is used for configuration from FallenStrapRPC
        ...
        public Button[] GetButtons()
        {
            ...
            {
                Label = "FallenStrap",
                Url = "https://github.com/zShift1/FallenStrap"
            });
