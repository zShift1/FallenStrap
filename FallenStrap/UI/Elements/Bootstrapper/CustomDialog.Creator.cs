...
namespace FallenStrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["FallenStrapCustomBootstrapper"] = HandleXmlElement_FallenStrapCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "FallenStrapCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "FallenStrapCustomBootstrapper");
            ...
            switch (version)
            {
                ...
                case 0: // Themes made between Oct 19, 2024 to Mar 11, 2025 (on the feature/custom-bootstrappers branch)
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotSupported", "FallenStrapCustomBootstrapper", version);
                default:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotRecognised", "FallenStrapCustomBootstrapper", version);
            }
        }
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "FallenStrapCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "FallenStrapCustomBootstrapper");
            ...
            // handle root
            HandleXmlElement_FallenStrapCustomBootstrapper(this, xml);
