...
{
    public class FallenStrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"FallenStrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "FallenStrapViewModel::AddFilesToZipStream";
